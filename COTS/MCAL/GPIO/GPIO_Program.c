...
//						if(Copy_u8Speed==No_Pull){Clear_Bit(GPIO_A->PUPDR,GPIO_PUPDR_0_No_Pull);}
//						else if(Copy_u8Speed==Pull_Up){Set_Bit(GPIO_A->PUPDR,GPIO_PUPDR_0_Pull_Up);}
//						else{Set_Bit(GPIO_A->PUPDR,GPIO_PUPDR_0_Pull_Down);}
/******************************************************************************/
/*                                SINGLE  PIN                                 */
/******************************************************************************/
